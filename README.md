...
└── Documentation/
    ...
    └── Work/              Documentos fuente (LaTeX/Markdown) y bitácora
```
...
| `CU_eventos_completo.xlsx` | 25 casos de uso (CU-001..CU-025) con atributos de calidad e infraestructura |
...
| `BitacoraArquitectonica.md` | Bitácora arquitectónica: reuniones, decisiones de diseño, cambios y análisis |
...
- Cada entrada nueva de la bitácora documenta tipo, contexto, decisión, alternativas, riesgos y participantes.
