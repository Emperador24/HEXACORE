...
**Responsabilidad:** cuentas de usuario, roles y permisos, recintos y zonas (CU-027–029); proveedores,
pagos/conciliación financiera, y reportes y analítica (CU-030–032).

**Entidades del dominio (SAD §12, "Esquemas de administración general"):** Usuario, Rol, UsuarioRol,
Proveedor, Pago, Reporte.
