"""
Tokens de sesión para las pruebas de integración del CU-006.

Las suites usan compradores con UUID aleatorios —RNF-01 lanza cincuenta a la
vez—, que no existen en el Servicio de Administración y por tanto no pueden
iniciar sesión. Así que las pruebas **fabrican** sus tokens, firmándolos con la
clave privada de desarrollo, exactamente como lo haría Administración.
...
se busca: la prueba `rnf06-autenticacion.py` comprueba que un token firmado con
cualquier otra clave se rechaza.
