...
\textit{C4Diagrams.tex} (los seis diagramas C4), \textit{DistribucionCasosUso.tex} (los 32 casos
de uso) y \textit{BitacoraArquitectonica.md} (decisiones, alternativas y riesgos). Se añade
...
del SAD (ver \textit{TASKS.md}); la tabla siguiente resume los conceptos identificados hasta ahora
a partir de los 32 casos de uso.}
...
semperadorcontreras@gmail.com (contacto del equipo) & Diseñar y sustentar una arquitectura que
...
\begin{center}
\begin{longtable}{|p{1.1cm}|p{2.1cm}|p{1.9cm}|p{1.9cm}|p{2.1cm}|p{4cm}|p{1.6cm}|}
\hline
\textbf{ID ASR} & \textbf{Título} & \textbf{Atributo} & \textbf{Sub-atributo} &
\textbf{Funcionalidades} & \textbf{Escenario} & \textbf{Prioridad}\\
\hline
\endhead
...
disponibilidad. & Alta\\
\hline
ASR-02 & Disponibilidad durante el ingreso masivo & Disponibilidad & Tolerancia a fallos &
...
\hline
ASR-03 & Protección de datos de pago y credenciales & Seguridad & Confidencialidad & CU-001,
...
\hline
ASR-06 & Escalado independiente del servicio de Entradas & Escalabilidad & Escalabilidad
...
Media\\
\hline
ASR-07 & Auditoría de transferencias y pagos & Trazabilidad & Auditabilidad & CU-006, CU-031 &
...
\hline
ASR-09 & Evolución independiente de dominios & Mantenibilidad & Modificabilidad & Todos los CU
...
\hline
ASR-10 & Consumo uniforme vía API & Portabilidad & Independencia de plataforma & Todos los CU &
...
con el script de despliegue automatizado exigido para Entrega 2 (ver \textit{TASKS.md}). Se prevé
que reutilicen la misma topología de producción a menor escala (menos réplicas, sin CDN).}
...
\begin{center}
\begin{longtable}{|p{2.6cm}|p{1.7cm}|p{1.6cm}|p{1.5cm}|p{2.9cm}|p{2.9cm}|}
\hline
\textbf{Riesgo} & \textbf{Probabilidad} & \textbf{Impacto} & \textbf{Prioridad} & \textbf{Plan de
...
\textit{C4Diagrams.tex}, \textit{DistribucionCasosUso.tex} y
