...
Un único binario (Kotlin + Jetpack Compose) con una pantalla de login compartida: las credenciales
identifican el rol del usuario autenticado y la navegación interna abre el conjunto de pantallas
correspondiente, sin ser dos apps distribuidas por separado.
